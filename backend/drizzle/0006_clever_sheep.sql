CREATE TABLE `animals` (
	...
	CONSTRAINT `animals_rfid` UNIQUE(`rfid`)
);
...
--> statement-breakpoint
ALTER TABLE `animals` ADD CONSTRAINT `animals_exploitation_id_exploitations_id_fk` FOREIGN KEY (`exploitation_id`) REFERENCES `exploitations`(`id`) ON DELETE no action ON UPDATE no action;
