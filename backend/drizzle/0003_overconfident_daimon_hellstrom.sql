...
ALTER TABLE `fattening_feed_records` ADD CONSTRAINT `fk_ffr_batch` FOREIGN KEY (`fattening_batch_id`) REFERENCES `fattening_batches`(`id`) ON DELETE cascade ON UPDATE no action;