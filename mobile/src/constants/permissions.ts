...
export const PERMISSIONS_MAP: Record<string, string[]> = {
  ...
  manager: [
    ...
    // 🟢 REPRODUCTION - Manager (READ + EXPORT only - US-6.5)
  ...
  eleveur: [
    ...
    // 🟢 REPRODUCTION - Eleveur (FULL CRUD - US-6.1 à 6.4, 6.6)
  ...
  ouvrier: [
    ...
    // ❌ REPRODUCTION - Ouvrier (aucune permission)
  ...
  veterinaire: [
    ...
    // ❌ REPRODUCTION - Veterinaire (aucune permission)
  ...
  cooperative: [
    ...
    // ❌ REPRODUCTION - Cooperative (aucune permission)
    // ❌ IOT - Cooperative (aucune permission)
  ],
};
