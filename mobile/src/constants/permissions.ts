...
export function hasPermissionFromList(permissions: string[], module: string, action: string): boolean {
  return permissions.some(p => p === `${module}:${action}`);
}
