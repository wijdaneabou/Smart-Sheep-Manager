...
export default function FatteningPerformanceScreen() {
  ...
  const canRead = hasPermission("FATTENING", "READ");

  // 🔒 Guard: if no READ permission, show access denied
  if (!canRead) {
    return (
      <SafeAreaView style={styles.safeArea} edges={["top", "bottom"]}>
        ...
        <View style={styles.center}>
          ...
          <Text style={styles.accessDeniedText}>
            Vous n'avez pas la permission de consulter les performances.
          </Text>
        </View>
      </SafeAreaView>
    );
...
const styles = StyleSheet.create({
  ...
  // Added for access denied screen
  accessDeniedText: {
    fontSize: 16,
    color: "#666",
    textAlign: "center",
