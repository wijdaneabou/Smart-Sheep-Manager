  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={["top", "bottom"]}>
      ...
      >
        ...
        {/* If the user cannot create, show a message */}
        {!canCreate && feedRecords.length === 0 && (
          <View style={styles.empty}>
            <Text style={styles.emptyText}>Vous n'avez pas la permission d'ajouter des enregistrements d'alimentation.</Text>
          </View>
        )}
