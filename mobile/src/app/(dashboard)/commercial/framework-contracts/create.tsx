...
import { createFrameworkContract, type ContractStatus } from "../../../../services/frameworkContractsService";
...
export default function CreateFrameworkContractScreen() {
  ...
  async function handleSubmit() {
    ...
    const result = await createFrameworkContract({
    ...
    <SafeAreaView style={styles.safeArea} edges={["top", "bottom"]}>
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Nouveau contrat cadre</Text>
          <View style={{ width: 32 }} />
        </View>
          ...
          >
            {loading ? (
              ...
              <>
                ...
                <Text style={styles.buttonText}>Créer le contrat</Text>
              </>
            )}
          </Pressable>
        </ScrollView>
