...
import { getProductById, updateProduct, type ProductCategory, type ProductAvailability } from "../../../../../services/productsService";
  ...
  useEffect(() => {
    async function load() {
      ...
      if (result.success && result.product) {
        ...
        setAvailability(result.product.availability);
        setPhotos(result.product.photos || "");
        setSpecifications(result.product.specifications || "");
      } else {
        setError(result.message || "Produit introuvable.");
      }
    }
    load();
  }, [id]);
