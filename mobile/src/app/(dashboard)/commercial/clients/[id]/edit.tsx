...
import { getClientById, updateClient, type ClientType } from "../../../../../services/clientsService";
...
export default function EditClientScreen() {
  ...
  useEffect(() => {
    async function load() {
      ...
      if (result.success && result.client) {
        ...
        setContact(result.client.contact);
        setType(result.client.type);
        setPreferences(result.client.preferences || "");
  ...
  async function handleSubmit() {
    ...
    const result = await updateClient(Number(id), {
      name: name.trim(),
